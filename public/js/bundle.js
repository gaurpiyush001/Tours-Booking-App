      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            console.log('dkfbdjfd', _context.t0.response.data);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // console.log(res);
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged Out'); //location.reload(true);//this will force a reload from server not from browser
...
exports.passwordUpdationHandler = exports.nameEmailUpdationHandler = void 0;
...
var nameEmailUpdationHandler = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              console.log(res.data.status);
              (0, _alerts.showAlert)('success', 'Credentials updated Successfully!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            } // console.log(res);
  ...
  return function nameEmailUpdationHandler(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.nameEmailUpdationHandler = nameEmailUpdationHandler;

var passwordUpdationHandler = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(prevPassword, newPassword, newPasswordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              console.log(res.data.status);
              (0, _alerts.showAlert)('success', 'Password updated Succesfuly!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            } // console.log(res);
  ...
  return function passwordUpdationHandler(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.passwordUpdationHandler = passwordUpdationHandler;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KYo8uSJYexT5jtOLmbWQWIQCXJYDAdQecnazCVJxzQ7r1NhK3y1bnD59voxOmPgTuuj2qRQgW4DV8oJWaTJ7Un400GipNFH12'); // 1)Get the session form the endpoint of Api
          ...
          case 4:
            ...
            console.log(session); // 2)Create checkput form + charge the credit card -- > this will be done by Stripe Object
...
var userGeneralUpdationForm = document.querySelector('.form-user-data');
var userPasswordUpdationForm = document.querySelector('.form-user-settings');
var bookBtn = document.getElementById('book-tour');

if (form) {
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log('login form submitted'); // console.log(email);
...
if (userGeneralUpdationForm) {
  userGeneralUpdationForm.addEventListener('submit', function (e) {
    e.preventDefault(); //Now we need to proramattically create "multipart/form-data"

    var form = new FormData(); //now in this form we need to keep appending new data

    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    console.log(form); // console.log('User updation Handler');

    (0, _updateSettings.nameEmailUpdationHandler)(form);
  });
}

if (userPasswordUpdationForm) {
  userPasswordUpdationForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateSettings.passwordUpdationHandler)(currentPassword, newPassword, confirmNewPassword);
